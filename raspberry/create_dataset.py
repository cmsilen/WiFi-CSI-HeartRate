...
def csi_data_read_parse(port: str, port_hr: str, csv_writer, log_file_fd,callback=None):
    ...
    while True:
        ...
        avg_bpm_str = string_hr.rstrip('\\r\\n\'')
        avg_bpm_str = avg_bpm_str.split("Avg BPM=")[1]
        ...
        train.write(','.join(map(str, shaped)) + ',' + avg_bpm + '\n')
...
if __name__ == '__main__':
    ...
    csi_data_read_parse(serial_port, serial_port_hr, csv.writer(open(file_name, 'w')), open(log_file_name, 'w'))